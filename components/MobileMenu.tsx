  ...
  return (
    <div className="bg-black w-56 absolute top-8 left-0 py-5 flex-col border-2 border-gray-800 flex">
      <div className="flex flex-col gap-4">
        ...
        <div onClick={() => router.push(`/browse/movies`)} className="px-3 text-center text-white active:text-gray-400 hover:text-gray-300 hover:underline hover:translate-y-[-2px] transition-transform duration-200">Films</div>
